...
class _$GetOrderDetailImpl implements _GetOrderDetail {
  const _$GetOrderDetailImpl(this.id);
  ...
  @override
  String toString() {
    return 'OrderDetailEvent.getOrderDetail(id: $id)';
  }
...
abstract class _GetOrderDetail implements OrderDetailEvent {
  const factory _GetOrderDetail(final int id) = _$GetOrderDetailImpl;
...
mixin _$OrderDetailState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(OrderDetailResponseModel data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(OrderDetailResponseModel data)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({OrderDetailResponseModel data});
}
...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  String toString() {
    return 'OrderDetailState.loaded(data: $data)';
  }
...
abstract class _Loaded implements OrderDetailState {
  const factory _Loaded(final OrderDetailResponseModel data) = _$LoadedImpl;

  OrderDetailResponseModel get data;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
