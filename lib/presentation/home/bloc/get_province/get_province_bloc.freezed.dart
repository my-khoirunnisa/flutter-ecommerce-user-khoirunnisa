...
mixin _$GetProvinceState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Province> result) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Province> result)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Province> result) : _result = result;

  final List<Province> _result;
  @override
  List<Province> get result {
  ...
  @override
  String toString() {
    return 'GetProvinceState.loaded(result: $result)';
  }
...
abstract class _Loaded implements GetProvinceState {
  const factory _Loaded(final List<Province> result) = _$LoadedImpl;
